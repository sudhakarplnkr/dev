...
export class DashboardClient {
    ...
    get(): Promise<HomeDashboard | null> {
    ...
    protected processGet(response: Response): Promise<HomeDashboard | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? HomeDashboard.fromJS(resultData200) : <any>null;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<HomeDashboard | null>(<any>null);
    }

    query(projectId: string): Promise<Team[] | null> {
        let url_ = this.baseUrl + "/api/Dashboard/Query?";
        if (projectId === undefined || projectId === null)
            throw new Error("The parameter 'projectId' must be defined and cannot be null.");
        else
            url_ += "ProjectId=" + encodeURIComponent("" + projectId) + "&"; 
    ...
    protected processQuery(response: Response): Promise<Team[] | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class ProjectPlanClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    query(projectId: string): Promise<ProjectPlan[] | null> {
        let url_ = this.baseUrl + "/api/ProjectPlan?";
        if (projectId === undefined || projectId === null)
            throw new Error("The parameter 'projectId' must be defined and cannot be null.");
        else
            url_ += "ProjectId=" + encodeURIComponent("" + projectId) + "&"; 
    ...
    protected processQuery(response: Response): Promise<ProjectPlan[] | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ProjectPlan.fromJS(item));
            }
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
        ...
        return Promise.resolve<ProjectPlan[] | null>(<any>null);
    }

    post(request: CreateProjectPlan | null): Promise<ProjectPlan | null> {
        let url_ = this.baseUrl + "/api/ProjectPlan";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processPost(response: Response): Promise<ProjectPlan | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ProjectPlan.fromJS(resultData200) : <any>null;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
    ...
    put(id: string, request: ProcessUpdateProjectPlan | null): Promise<ProjectPlan | null> {
        let url_ = this.baseUrl + "/api/ProjectPlan/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processPut(response: Response): Promise<ProjectPlan | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class AssociateDetails implements IAssociateDetails {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.fse = data["Fse"];
            this.fseEligibility = data["FseEligibility"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["Fse"] = this.fse;
        data["FseEligibility"] = this.fseEligibility;
        return data; 
    }
}
...
export class HomeDashboard implements IHomeDashboard {
    dashboard?: Dashboard[] | undefined;
    fse?: DashboardFse | undefined;

    constructor(data?: IHomeDashboard) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["Dashboard"] && data["Dashboard"].constructor === Array) {
                this.dashboard = [] as any;
                for (let item of data["Dashboard"])
                    this.dashboard!.push(Dashboard.fromJS(item));
            }
            this.fse = data["Fse"] ? DashboardFse.fromJS(data["Fse"]) : <any>undefined;
        }
    }

    static fromJS(data: any): HomeDashboard {
        data = typeof data === 'object' ? data : {};
        let result = new HomeDashboard();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["Fse"] = this.fse ? this.fse.toJSON() : <any>undefined;
        return data; 
    }
}
...
export class Dashboard implements IDashboard {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.associateId = data["AssociateId"];
            this.associateName = data["AssociateName"];
            this.podCompletionPercentage = data["PodCompletionPercentage"];
            this.fse = data["Fse"];
            this.fseEligibility = data["FseEligibility"];
    ...
    toJSON(data?: any) {
        ...
        data["AssociateId"] = this.associateId;
        data["AssociateName"] = this.associateName;
        data["PodCompletionPercentage"] = this.podCompletionPercentage;
        data["Fse"] = this.fse;
        data["FseEligibility"] = this.fseEligibility;
        data["DesiredLevel"] = this.desiredLevel;
        return data; 
    }
}
...
export class DashboardFse implements IDashboardFse {
    completedFse!: number;
    fseCount!: number;

    constructor(data?: IDashboardFse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.completedFse = data["CompletedFse"];
            this.fseCount = data["FseCount"];
        }
    }

    static fromJS(data: any): DashboardFse {
        data = typeof data === 'object' ? data : {};
        let result = new DashboardFse();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["CompletedFse"] = this.completedFse;
        data["FseCount"] = this.fseCount;
        return data; 
    }
}

export interface IDashboardFse {
    completedFse: number;
    fseCount: number;
}
...
export class ProjectPlan implements IProjectPlan {
    ...
    week!: number;
    day!: number;
    knowledgeTransfer?: KnowledgeTransfer | undefined;
    associatePlan?: AssociatePlan[] | undefined;

    constructor(data?: IProjectPlan) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.week = data["Week"];
            this.day = data["Day"];
            this.knowledgeTransfer = data["KnowledgeTransfer"] ? KnowledgeTransfer.fromJS(data["KnowledgeTransfer"]) : <any>undefined;
            if (data["AssociatePlan"] && data["AssociatePlan"].constructor === Array) {
                this.associatePlan = [] as any;
                for (let item of data["AssociatePlan"])
                    this.associatePlan!.push(AssociatePlan.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ProjectPlan {
        data = typeof data === 'object' ? data : {};
        let result = new ProjectPlan();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["Week"] = this.week;
        data["Day"] = this.day;
        data["KnowledgeTransfer"] = this.knowledgeTransfer ? this.knowledgeTransfer.toJSON() : <any>undefined;
        if (this.associatePlan && this.associatePlan.constructor === Array) {
            data["AssociatePlan"] = [];
            for (let item of this.associatePlan)
                data["AssociatePlan"].push(item.toJSON());
        }
        return data; 
    }
}
...
export class CreateProjectPlan implements ICreateProjectPlan {
    id!: string;
    projectId!: string;
    knowledgeTransferId!: string;
    week!: number;
    ...
    constructor(data?: ICreateProjectPlan) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateProjectPlan {
        data = typeof data === 'object' ? data : {};
        let result = new CreateProjectPlan();
        result.init(data);
        return result;
    }
...
export interface ICreateProjectPlan {
    id: string;
    projectId: string;
    knowledgeTransferId: string;
    week: number;
...
export class ProcessUpdateProjectPlan implements IProcessUpdateProjectPlan {
    id!: string;
    projectId!: string;
    roleId!: string;
    knowledgeTransferId!: string;
    ...
    constructor(data?: IProcessUpdateProjectPlan) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProcessUpdateProjectPlan {
        data = typeof data === 'object' ? data : {};
        let result = new ProcessUpdateProjectPlan();
        result.init(data);
        return result;
    }
...
export interface IProcessUpdateProjectPlan {
    id: string;
    projectId: string;
    roleId: string;
    knowledgeTransferId: string;
