...
import { addAssociateDetail, buildAssociateSearchParam, deleteAssociate, loadAddAssociate, loadAssociate, loadTeam, updateAssociateModel } from '../actions/AssociateActions';
...
class AssociateContainer extends React.Component<IAssociateProps, {}> {
