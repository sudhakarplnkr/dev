                ...
                <form>
                    <fieldset>
                        ...
                        <div className="form-group col-md-1">
                            <label>FSE Eligibility</label>
                            <label className="container">
                                <input type="checkbox" checked={EmployeeDetails && EmployeeDetails.fseEligibility} name="form-control" onChange={(event) => props.updateAssociateDetail({ fseEligibility: event.target.checked })} />
                        ...
                        <div className="form-group col-md-1">
                            <label>FSE</label>
                            <label className="container">
                                <input type="checkbox" checked={EmployeeDetails && EmployeeDetails.fse} name="form-control" onChange={(event) => props.updateAssociateDetail({ fse: event.target.checked })} disabled={EmployeeDetails && EmployeeDetails.fseEligibility ? false : true} />
                                <span className="checkmark" />
                            </label>
                        </div>
                    </fieldset>
